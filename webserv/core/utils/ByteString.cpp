...
size_t		ByteString::append(const char* s) {return append(s, std::strlen(s));}
...
size_t		ByteString::find(byte c, size_t pos) const {
	return find(&c, 1, pos);
}
...
size_t		ByteString::find(const char* s, size_t pos) const {return find(s, std::strlen(s), pos);}
size_t		ByteString::find_first_not_of(const char* s, size_t pos) const {return find_first_not_of(s, std::strlen(s), pos);}
size_t		ByteString::find_last_not_of(const char* s, size_t pos) const {return find_last_not_of(s, std::strlen(s), pos);}
size_t		ByteString::find_first_of(const char* s, size_t pos) const {return find_first_of(s, std::strlen(s), pos);}
size_t		ByteString::find_last_of(const char* s, size_t pos) const {return find_last_of(s, std::strlen(s), pos);}
